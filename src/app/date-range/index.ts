...
export { DateRangeDirective } from './date-range/hc-date-range.component';
export { PresetItem, DateRange, DateRangeOptions } from './model/model';
...
export { DateRangeModule } from './hc-date-range.module';
